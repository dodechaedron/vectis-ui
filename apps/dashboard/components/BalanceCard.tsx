        ...
        <ul role="list" className="divide-y divide-gray-200">
          <li className="flex items-center gap-2 px-4 py-4 sm:px-6">
            ...
            <div className="flex flex-1 items-center justify-between">
              <p className="text-md font-medium capitalize text-black">{balance?.denom || defaultFee.symbol}</p>
              <p className="text-lg text-black/70">{convertMicroDenomToDenom(balance?.amount).toFixed(2) || 0}</p>
            </div>
          </li>
        </ul>
      </div>
